...
extern void lcdSendCommand (const int fd, const uint8_t command) ;
extern void lcdPosition    (const int fd, const int x, const int y) ;
extern void lcdPutchar     (const int fd, const uint8_t data) ;
